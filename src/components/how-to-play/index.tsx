      ...
      <div className="flex justify-between w-full mb-[5rem]">
        <Link to="/" className="rounded-full">
          <button className="rounded-full">
            <img
              className="p-[0.8rem] rounded-full bg-gradient-to-b from-[#FE71FE] to-[#7199FF]"
              src={GoBack}
              alt="GoBack"
            />
          </button>
        </Link>
        <h1 className="text-[3rem] leading-[3.6rem] tracking-[5%] inline-block bg-gradient-to-b from-[#67B6FF] to-[#FFF] text-transparent bg-clip-text">
          How to Play
        </h1>
      </div>
      <div>
        <div className="p-[2rem] bg-[#FFF] rounded-3xl max-w-[39rem] w-full mb-[1.5rem]">
          <div className="flex gap-[1rem] mb-[1rem]">
            <span className="text-[1.5rem] leading-[1.8rem] tracking-[5%] text-[#2463FF]">
              01
            </span>
            <h2 className="text-[1.5rem] leading-[1.8rem] tracking-[5%] text-[#261676]">
              Choose a category
            </h2>
          </div>
          <p className="text-[1rem] leading-[1.2rem] tracking-[5%] text-[#887DC0] max-w-[16.5rem] w-full">
